...
<div class="info">
  <h1 align="center" class="logo dth">Как зайти на сервер?</h1>
<style type="text/css">
...
<div class="row">
  ...
  <div class="step">
    ...
    <p class="<?php if ($des->on == "on") echo "new-pok"; ?>">Зайдите в игру, после чего откройте ее и нажмите на кнопку "Сетевая игра".</p>
  ...
  <div class="step">
    ...
    <p class="<?php if ($des->on == "on") echo "new-pok"; ?>">В поле "Адрес сервера" введите айпи <?php echo $shopsettings->ip; ?></p>
    ...
    <p class="<?php if ($des->on == "on") echo "new-pok"; ?>">Нажмите на кнопку "Добавить". 
    </p>
    ...
    <p class="<?php if ($des->on == "on") echo "new-pok"; ?>">Чтобы зайти нажмите на появившийся сервер два раза.</p>
