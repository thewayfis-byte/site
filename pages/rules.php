...
<div class="info">
  <h1 align="center" class="logo dth">Правила проекта</h1>
<?php foreach ($rules as $key): ?>
  <div class="rule <?php if ($des->on == "on") echo "new-pok"; ?>">
    <h3 class="<?php if ($des->on == "on") echo "new-rul"; ?>"><?php echo $key->name; ?></h3>
